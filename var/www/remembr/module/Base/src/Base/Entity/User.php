...
class User
{
	...
	public function getKey() { return $this->confirmKey; }
	public function setKey($value) { $this->confirmKey = $value; return $this;}
	...
	public function exchangeArray(array $values) {
		if (isset($values['email'])) $this->email = $values['email'];
