...
namespace TH\ZfctwigTranslation\Node;
...
class Trans extends \Twig_Node
{
    ...
    public function compile(\Twig_Compiler $compiler)
    {
        ...
        $function = null === $this->getNode('plural') ? '$this->env->getExtension(\'th_zfctwig_i18n\')->translate' : '$this->env->getExtension(\'th_zfctwig_i18n\')->translatePlural';
